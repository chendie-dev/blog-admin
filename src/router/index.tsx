...
const OprationLog=lazy(()=>import('../pages/OperationLog'))
...
const routers = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: '/pages',
                element: withLoading(<Pages />, 'page')
            },
            {
                path: '/operation/log',
                element: withLoading(<OprationLog />, 'operationlog')
            },
            {
                path: '/other',
                element: withLoading(<Other />, 'other')
            },
        ]
    },
    {
